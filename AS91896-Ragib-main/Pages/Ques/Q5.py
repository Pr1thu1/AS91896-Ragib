...
# Answers
answer1 = "Poi - Hawaii"
answer2 = "Kitfo - Ethiopia"
answer3 = "Kitfo - Nigeria"
answer4 = "Coxinha - Brazil"


correct_answer = "Coxinha - Brazil"
...
def answer_clicked(chosen):
    ...
    subprocess.Popen([sys.executable, os.path.join(os.path.dirname(__file__), "Q6.py")])
    root.destroy()
